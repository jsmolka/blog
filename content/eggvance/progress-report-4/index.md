...
{{<wrap>}}
  {{<image src="images/yeti-bitmap-bug.png" caption="Yeti demo without matrix transformation">}}
  {{<image src="images/yeti-bitmap.png" caption="Yeti demo with matrix transformation">}}
{{</wrap>}}
...
{{<wrap>}}
  {{<image src="images/safety-screen-bug.png" caption="Mother 3 without color masking">}}
  {{<image src="images/safety-screen.png" caption="Mother 3 with color masking">}}
{{</wrap>}}
...
{{<wrap>}}
  {{<image src="images/pokemon-series-bug.png" caption="Uninitialized sprites in the top left corner">}}
  {{<image src="images/pokemon-series.png" caption="No sprites in the top left corner">}}
{{</wrap>}}
...
{{<wrap>}}
  {{<image src="images/doom-rainbow-floor.png" caption="DOOM II rainbow floor">}}
  {{<image src="images/doom.png" caption="DOOM II fixed">}}
{{</wrap>}}
