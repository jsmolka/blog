...
- ![](img/bg0.png "Background layer 0")
- ![](img/bg1.png "Background layer 1")
{.fluent}

- ![](img/bg2.png "Background layer 2")
- ![](img/obj.png "Object layer")
{.fluent}
...
- ![](img/blend.png "Blending backgrounds 0 and 1")
- ![](img/scene.png "Final scene")
{.fluent}
...
Timing an emulator can be quite hard. If the frame has been rendered early, there isn't much you can do aside from waiting. The GBA has a refresh rate of 59.737 Hz, 280,896 cycles per frame on a 16.78 MHz CPU. The ideal frame time for this scenario is 16.74 ms.
