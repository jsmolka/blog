...
- ![](img/sapphire-bad-bios-bug.png "Freezing during intro sequence")
- ![](img/sapphire-bad-bios.png "In the moving truck where we belong")
{.fluent}
...
- ![](img/gunstar-sprite-cycles-bug.png "Gunstar Super Heroes without render cycle limit")
- ![](img/gunstar-sprite-cycles.png "Gunstar Super Heroes with render cycle limit")
{.fluent}
...
- ![](img/emerald-bad-rtc.png "Empty battery warning")
- ![](img/emerald-bad-flash.png "Ever saw that back then? (bonus)")
{.fluent}
...
- ![](img/emerald-berry-1.png "Saplings planted")
- ![](img/emerald-berry-2.png "Time to harvest")
{.fluent}
...
- ![](img/sennen-rtc-bug.png "Complaints about a bad RTC")
- ![](img/sennen-rtc.png "Fixed and ready for the intro")
{.fluent}
...
![](audio/tengoku.mp3 "Intro sequence of Rhythm Tengoku with some nice stereo")
