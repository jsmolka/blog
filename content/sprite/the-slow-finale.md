...
{{<wrap>}}
  ...
  {{<image src="sprite/super-mario-land.png" caption="Super Mario Land stage three boss">}}
{{</wrap>}}
...
{{<wrap>}}
  ...
  {{<image src="sprite/zelda-bow-wow.png" caption="[Madam MeowMeow's](https://zelda.fandom.com/wiki/Madam_MeowMeow) [BowWow](https://zelda.fandom.com/wiki/BowWow)">}}
{{</wrap>}}

{{<wrap>}}
  {{<image src="sprite/zelda-shield.png" caption="Link receives his shield">}}
  {{<image src="sprite/zelda-sword.png" caption="Not the Master Sword">}}
{{</wrap>}}
