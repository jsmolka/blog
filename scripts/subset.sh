pyftsubset Inter.ttf --unicodes="U+0000-017F,U+2000-20CF,U+2192,U+2190,U+21A9" --layout-features="calt,ccmp,kern,cv07,tnum" --flavor="woff2" --output-file="../static/fonts/inter.woff2"
