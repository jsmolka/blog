...
@font-face {
  ...
  font-weight: 100 900;
  font-display: block;
  src: url('/fonts/inter.woff2?md5=${hash_inter}') format('woff2');
}
...
@font-face {
  ...
  font-display: block;
  font-style: normal;
  src: url('/fonts/jetbrains-mono.woff2?md5=${hash_jetbrains_mono}') format('woff2');
}
...
@font-face {
  ...
  font-display: block;
  font-style: italic;
  src: url('/fonts/jetbrains-mono-italic.woff2?md5=${hash_jetbrains_mono_italic}') format('woff2');
}
" > "../assets/scss/_typography.scss"

echo -n "<!-- Auto generated by subset.sh -->

<link href=\"/fonts/inter.woff2?md5=${hash_inter}\" rel=\"preload\" as=\"font\" type=\"font/woff2\" crossorigin=\"\">
<link href=\"/fonts/jetbrains-mono.woff2?md5=${hash_jetbrains_mono}\" rel=\"preload\" as=\"font\" type=\"font/woff2\" crossorigin=\"\">
<link href=\"/fonts/jetbrains-mono-italic.woff2?md5=${hash_jetbrains_mono_italic}\" rel=\"preload\" as=\"font\" type=\"font/woff2\" crossorigin=\"\">
